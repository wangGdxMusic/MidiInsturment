 ...
 * pointing to the carRun, an y-axis pointing upwards and the origin is in the lower left corner of the screen. You can also
...
public class PolygonSpriteBatch implements Batch {
	 ...
	 * x-axis point to the carRun and the origin being in the bottom left corner of the screen. The projection will be pixel perfect
